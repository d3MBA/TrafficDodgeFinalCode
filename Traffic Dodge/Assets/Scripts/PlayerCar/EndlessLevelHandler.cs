...
public class EndlessLevelHandler : MonoBehaviour
{
    ...
    GameObject[] sectionsPool = new GameObject[20]; // number of sections that will be in the pool

    GameObject[] sections = new GameObject[10]; // number of sections that will be active at the same time
